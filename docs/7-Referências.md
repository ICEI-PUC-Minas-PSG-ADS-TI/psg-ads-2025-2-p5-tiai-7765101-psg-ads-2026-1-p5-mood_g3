...
* **Referência da ODS (Obrigatório):**
    ...
    Disponível em: [<https://brasil.un.org/pt-br/sdgs/3>](https://www.ipea.gov.br/ods/ods3.html). 
...
* **Documentação Técnica (Frameworks e Banco de Dados):**
    ...
    Disponível em: [<https://learn.microsoft.com/pt-br/aspnet/core>](https://docs.djangoproject.com/en/6.0/). 
