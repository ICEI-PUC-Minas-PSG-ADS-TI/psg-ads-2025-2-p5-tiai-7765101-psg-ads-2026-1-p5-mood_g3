...
| Francisco Henrique de Moura    | Arquiteto de Dados   | Deploy da Aplicação: Disponibilizar o sistema em ambiente acessível (deploy), garantindo que esteja funcional para avaliação e preencher síntese dos resultados, conexão com a ODS, limitações, trabalhos futuros e lições aprendidas | 14/05 | 25/06 | ✔️  |
