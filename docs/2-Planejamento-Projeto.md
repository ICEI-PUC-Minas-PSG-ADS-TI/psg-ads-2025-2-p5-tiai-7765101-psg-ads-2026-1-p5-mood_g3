...
| Responsável                    | Papel                | Tarefa | Início | Prazo | Status |
|--------------------------------|----------------------|--------|--------|--------|--------|
| Camila Machado Pires Maia      | Facilitador Ágil     | Documentação Final Consolidada: Toda a documentação atualizada e coerente com o código final no GitHub e criação dos slides de apresentação | 14/05 | 05/06 | ✔️ |
